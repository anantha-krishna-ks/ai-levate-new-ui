          ...
          <div className="max-w-md text-center space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Sign in to your account and continue your AI-powered journey with intelligent workflows and automation.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="text-center mb-8">
                  <div className="text-sm text-gray-500 mb-4">
                    ...
                    <button 
                      ...
                      className="text-primary hover:text-primary/80 font-medium transition-colors underline hover-primary"
                    >
                      Sign up
                    </button>
                  </div>
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  <div>
                    <Input
                      ...
                      className="h-12 border-gray-200 bg-white/80 focus:border-primary focus:ring-primary/20 transition-all duration-200 hover-border-primary"
                    />
                  </div>
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="h-12 border-gray-200 bg-white/80 focus:border-primary focus:ring-primary/20 transition-all duration-200 hover-border-primary pr-12"
                    />
                    <button
                      type="button"
                      onClick={() => setShowPassword(!showPassword)}
                      className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-primary transition-colors hover-primary"
                    >
                  ...
                  <div className="flex items-center justify-between">
                    <button
                      type="button"
                      className="text-sm text-primary hover:text-primary/80 transition-colors underline hover-primary"
                    >
                      Forgot password?
                    </button>
                  </div>
                  ...
                  <Button 
                    type="submit"
                    disabled={!canSubmit()}
                    className="w-full h-12 bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary text-white font-semibold rounded-lg shadow-lg transform transition-all duration-200 hover:scale-[1.02] disabled:opacity-50 hover-glow"
                  >
                    Sign In
                  </Button>
                </form>
            ...
            <div className="mt-8 text-center space-y-2">
              ...
              <div className="text-xs text-gray-400 space-y-1">
                ...
                <div className="flex items-center justify-center space-x-4">
                  <a href="#" className="hover:text-primary transition-colors hover-primary">Privacy and Cookie Policy</a>
                  <span>•</span>
                  <a href="#" className="hover:text-primary transition-colors hover-primary">Help</a>
                  <span>•</span>
