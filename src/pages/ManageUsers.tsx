        ...
        <header className="sticky top-0 z-50 bg-white border-b">
          <div className="flex h-16 items-center justify-between px-4 lg:px-6">
            <div className="flex items-center gap-4 lg:gap-6">
              <h1 className="text-lg lg:text-xl font-semibold text-gray-900">User Management</h1>
              <p className="hidden md:block text-sm text-gray-600">Admin features in development</p>
            </div>
            <ProfileDropdown />
          </div>
        </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <Card className="p-6 bg-white border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 group">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Admin Panel</p>
              ...
              <Card className="p-6 bg-white border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 group">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">Mar</p>
                    <p className="text-xs text-green-600">2025</p>
                  </div>
              ...
              <Card className="p-6 bg-white border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 group">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-purple-600">Role Types</p>
                  </div>
                ...
                <div className="absolute bottom-6 left-6 text-white">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/90">Advanced admin tools in development</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="text-center space-y-6">
                  <div className="space-y-4">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                      Powerful admin tools for managing users, roles, permissions, and organizational settings. Complete control over your team's access and capabilities.
                    </p>
                  </div>
                  ...
                  <div className="flex items-center justify-center gap-2 my-8">
                    ...
                    <div className="w-3 h-3 rounded-full bg-blue-400 animate-bounce" style={{ animationDelay: '0.1s' }} />
                    <div className="w-3 h-3 rounded-full bg-blue-300 animate-bounce" style={{ animationDelay: '0.2s' }} />
                  </div>
              ...
              {features.map((feature, index) => (
                ...
                >
                  <CardContent className="p-6 text-center">
                    <div className={`w-12 h-12 mx-auto mb-4 rounded-lg bg-purple-500/10 flex items-center justify-center text-purple-600 transform transition-all duration-300 ${
                      hoveredFeature === index ? 'scale-110 bg-purple-500 text-white' : ''
                    }`}>
                      {feature.icon}
                    </div>
